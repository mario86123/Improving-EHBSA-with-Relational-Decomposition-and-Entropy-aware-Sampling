...
#ifndef __RankingEDA__ACHIGN__
#define __RankingEDA__ACHIGN__
...
class CACHIGN : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CACHIGN(int problem_size, int sel_size, double b_ratio);
    ...
    void Sample(int * permutation, int * templateee, int need_to_sample_gene_count, double chi_std);
...
#endif /* defined(__RankingEDA__ACHIGN__) */