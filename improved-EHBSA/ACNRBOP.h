...
#ifndef __RankingEDA__ACNRBOP__
#define __RankingEDA__ACNRBOP__
...
class CACNRBOP : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CACNRBOP(int problem_size, int sel_size, double b_ratio);
     ...
     */
    bool Learn(CPopulation * population, int mode, int * used_distance_count_arr);
...
#endif /* defined(__RankingEDA__ACNRBOP__) */