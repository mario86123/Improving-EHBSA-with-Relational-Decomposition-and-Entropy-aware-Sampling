 ...
 * Class constructor.
 */
CAGNRBOP::CAGNRBOP(int problem_size, int sel_size, double b_ratio)
{
 ...
 */
// bool CAGNRBOP::Learn(CPopulation * population, int size)
//
// mode == 1 -> upper half population
// mode == 2 -> lower half population
// mode == 3 -> whole population
bool CAGNRBOP::Learn(CPopulation * population, int mode)
{   
    // population->Print();
    // cout << endl;
 ...
 */
void CAGNRBOP::Sample(int * genes, int * templateee, int need_to_sample_gene_count)
{
...
edgeee CAGNRBOP::add_edgesss(int sampled_node_num, int sampled_node_idx, list<edgeee>& edge_lst, bool * is_sampled_node, bool * is_sampled_idx) {
...
edgeee CAGNRBOP::Build_network(int * templateee, int already_sampled_idx_count, list<edgeee>&  edge_lst, int * sampled_or_not_idx, bool * is_sampled_node) {
...
double CAGNRBOP::fast_calculate_entropy(int * arr, int summation) {
...
// update edges information and delete unsable edgesss
edgeee CAGNRBOP::update_and_find_lowest_entropy_edge(int sample_idx, int sample_node_num, list<edgeee>&  edge_lst) {
...
void CAGNRBOP::construct_probability_array(double * tmp_probability_array, bool * is_sampled_node, edgeee lowest_entropy_edge) {
