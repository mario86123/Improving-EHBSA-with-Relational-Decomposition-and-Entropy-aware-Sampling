 ...
 * Class constructor.
 */
CAMST::CAMST(int problem_size, int sel_size, double b_ratio, string result_file_name)
{
 ...
 */
bool CAMST::Learn(CPopulation * population, int size)
{   
 ...
 */
void CAMST::Sample(int * genes, int number_of_edge)
{
    ...
    mst_edge mst_edge_lst[number_of_edge];
    for (int num = 0; num < number_of_edge ; num++) {
    ...
    for (int sample_count = 0; sample_count < m_problem_size; sample_count++) {
        ...
        for (int edge_num = 0; edge_num < number_of_edge; edge_num ++) {
