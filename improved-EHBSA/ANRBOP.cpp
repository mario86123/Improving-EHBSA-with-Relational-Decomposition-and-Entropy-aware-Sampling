 ...
 * Class constructor.
 */
CANRBOP::CANRBOP(int problem_size, int sel_size, double b_ratio)
{
 ...
 */
bool CANRBOP::Learn(CPopulation * population, int size)
{   
    // population->Print();
    // cout << endl;
 ...
 */
void CANRBOP::Sample(int * genes, int * templateee, int need_to_sample_genes_count)
{
    int already_sampled_idx_count = m_problem_size - (need_to_sample_genes_count);
    // cout << "cut_point_percentage: " << cut_point_percentage << endl;
    // cout << "not_sampled_yet_idx_count: " << m_problem_size - already_sampled_idx_count << endl;
...
edgeee CANRBOP::add_edgesss(int sampled_node_num, int sampled_node_idx, list<edgeee>& edge_lst, bool * is_sampled_node, bool * is_sampled_idx) {
...
edgeee CANRBOP::Build_network(int * templateee, int already_sampled_idx_count, list<edgeee>&  edge_lst, int * sampled_or_not_idx, bool * is_sampled_node) {
...
double CANRBOP::fast_calculate_entropy(int * arr, int summation) {
...
// update edges information and delete unsable edgesss
edgeee CANRBOP::update_and_find_lowest_entropy_edge(int sample_idx, int sample_node_num, list<edgeee>&  edge_lst) {
...
void CANRBOP::construct_probability_array(double * tmp_probability_array, bool * is_sampled_node, edgeee lowest_entropy_edge) {
