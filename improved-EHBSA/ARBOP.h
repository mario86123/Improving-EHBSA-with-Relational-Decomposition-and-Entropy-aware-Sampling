...
#ifndef __RankingEDA__ARBOP__
#define __RankingEDA__ARBOP__
...
class CARBOP : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	// CARBOP(int problem_size, int sel_size, double b_ratio, int cut_point_count);
    CARBOP(int problem_size, int sel_size, double b_ratio, int cut_point_count, int node_edge_ratio_percent);
...
private:
    ...
    int m_node_edge_ratio_percent;



};

#endif /* defined(__RankingEDA__ARBOP__) */