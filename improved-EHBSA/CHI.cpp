 ...
 * Class constructor.
 */
CCHI::CCHI(int problem_size, int sel_size, double b_ratio)
{
 ...
 */
// bool CCHI::Learn(CPopulation * population, int size)
//
// mode == 1 -> upper half population
// mode == 2 -> lower half population
// mode == 3 -> whole population
bool CCHI::Learn(CPopulation * population, int mode)
{   
    // population->Print();
    // cout << endl;
 ...
 */
void CCHI::Sample(int * genes, int * templateee, int cut_point_count)
{
    ...
    for (int kkk = already_sampled_idx_count; kkk < m_problem_size; kkk++) {
        ...
        // === use node to sampled  === //
        if (lowest_entropy_edge.entropy > entropy_mean - 1 * entropy_std) {
...
edgeee CCHI::add_edgesss(int sampled_node_num, int sampled_node_idx, list<edgeee>& edge_lst, bool * is_sampled_node, bool * is_sampled_idx) {
...
edgeee CCHI::Build_network(int * templateee, int already_sampled_idx_count, list<edgeee>&  edge_lst, int * sampled_or_not_idx, bool * is_sampled_node) {
...
double CCHI::fast_calculate_entropy(int * arr, int summation) {
...
// update edges information and delete unsable edgesss
edgeee CCHI::update_and_find_lowest_entropy_edge(int sample_idx, int sample_node_num, list<edgeee>&  edge_lst) {
...
void CCHI::construct_probability_array(double * tmp_probability_array, bool * is_sampled_node, edgeee lowest_entropy_edge) {
...
void CCHI::construct_node_probability_array(double * tmp_probability_array, bool * is_sampled_node, int idx) {
