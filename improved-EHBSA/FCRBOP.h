...
#ifndef __RankingEDA__FCRBOP__
#define __RankingEDA__FCRBOP__
...
class CFCRBOP : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CFCRBOP(int problem_size, int sel_size, double b_ratio, int cut_point_count);
...
#endif /* defined(__RankingEDA__FCRBOP__) */