...
#ifndef __RankingEDA__FOUR__
#define __RankingEDA__FOUR__
...
class CFOUR : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CFOUR(int problem_size, int sel_size, double b_ratio);
     ...
     */
    bool Learn(CPopulation * population, int start_idx, int end_idx);
...
#endif /* defined(__RankingEDA__FOUR__) */