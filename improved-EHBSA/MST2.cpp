 ...
 * Class constructor.
 */
CMST2::CMST2(int problem_size, int sel_size, double b_ratio, string result_file_name)
{
	m_problem_size=problem_size;
    m_sample_size=sel_size;
    m_samples= new int*[m_sample_size];
    m_max_num_of_edge = m_problem_size - 1;
 ...
 */
bool CMST2::Learn(CPopulation * population, int size)
{   
...
void CMST2::Sample(int * genes)
{
    ...
    for (int sample_count = 1; sample_count < m_problem_size; sample_count++) {
        ...
        for (int i = 0; i < m_max_num_of_edge; i ++) {
            ...
            // cout << "mst_edge_lst["<<i<<"].status: "<<mst_edge_lst[i].status<<", a:"<<mst_edge_lst[i].node_a<<", b:"<<mst_edge_lst[i].node_b<<endl;
