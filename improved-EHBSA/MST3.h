...
#ifndef __RankingEDA__MST3__
#define __RankingEDA__MST3__
...
class CMST3 : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CMST3(int problem_size, int sel_size, double b_ratio, string result_file_name);
...
#endif /* defined(__RankingEDA__MST3__) */