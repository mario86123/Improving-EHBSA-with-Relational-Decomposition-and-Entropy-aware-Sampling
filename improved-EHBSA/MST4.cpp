 ...
 * Class constructor.
 */
CMST4::CMST4(int problem_size, int sel_size, double b_ratio, string result_file_name)
{
    ...
    m_how_many_trees = m_problem_size/5;
 ...
 */
bool CMST4::Learn(CPopulation * population, int size)
{   
