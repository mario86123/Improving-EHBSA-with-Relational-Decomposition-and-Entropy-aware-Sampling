...
#ifndef __RankingEDA__MST4__
#define __RankingEDA__MST4__
...
class CMST4 : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CMST4(int problem_size, int sel_size, double b_ratio, string result_file_name);
...
#endif /* defined(__RankingEDA__MST4__) */