...
#ifndef __RankingEDA__PREPRUNE__
#define __RankingEDA__PREPRUNE__
...
class CPREPRUNE : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CPREPRUNE(int problem_size, int sel_size, double b_ratio);
    ...
    edgeee add_edgesss(int sampled_node_num, int sampled_node_idx, list<edgeee>&  edge_lst, bool * is_sampled_node, bool * is_sampled_idx, int * count);
...
#endif /* defined(__RankingEDA__PREPRUNE__) */