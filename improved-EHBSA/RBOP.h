...
#ifndef __RankingEDA__RBOP__
#define __RankingEDA__RBOP__
...
class CRBOP : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CRBOP(int problem_size, int sel_size, double b_ratio, int cut_point_count);
...
#endif /* defined(__RankingEDA__RBOP__) */