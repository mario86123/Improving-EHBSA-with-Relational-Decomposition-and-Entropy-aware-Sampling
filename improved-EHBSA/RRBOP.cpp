 ...
 * Class constructor.
 */
CRRBOP::CRRBOP(int problem_size, int sel_size, double b_ratio, int cut_point_count)
{
 ...
 */
bool CRRBOP::Learn(CPopulation * population, int size)
{   
    // population->Print();
 ...
 */
void CRRBOP::Sample(int * genes, int * templateee)
{
    ...
    for (int kkk = 0; kkk < m_problem_size - already_sampled_idx_count; kkk++) {
        ...
        if (kkk < m_problem_size - already_sampled_idx_count - 1) {
...
int CRRBOP::Build_network(int * templateee, int already_sampled_idx_count, edgeee * edge_lst, int * sampled_or_not_idx, bool * is_sampled_node) {
...
int CRRBOP::update_and_find_lowest_entropy_edge(int sample_idx, int sample_node_num, int total_edge_count, edgeee * edge_lst) {

    double lowest_entropy = 100.0;
    int all_edges_lowest_entropy_num = -1;
    int remaining_edges_counts = 0;
    ...
    // cout << "remaining_edges_counts: " << remaining_edges_counts << endl;
    int rand_num = rand() % remaining_edges_counts;
...
void CRRBOP::construct_probability_array(double * tmp_probability_array, bool * is_sampled_node, int lowest_entropy_edge_num, edgeee * edge_lst) {
