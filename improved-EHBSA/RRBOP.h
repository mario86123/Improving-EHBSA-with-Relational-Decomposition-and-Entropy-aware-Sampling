...
#ifndef __RankingEDA__RRBOP__
#define __RankingEDA__RRBOP__
...
class CRRBOP : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CRRBOP(int problem_size, int sel_size, double b_ratio, int cut_point_count);
...
#endif /* defined(__RankingEDA__RRBOP__) */