...
#ifndef __RankingEDA__SRBOP__
#define __RankingEDA__SRBOP__
...
class CSRBOP : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CSRBOP(int problem_size, int sel_size, double b_ratio, int cut_point_count);
...
#endif /* defined(__RankingEDA__SRBOP__) */