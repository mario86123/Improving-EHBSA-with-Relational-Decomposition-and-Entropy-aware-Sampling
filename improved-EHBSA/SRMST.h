// Split Random MST model

#ifndef __RankingEDA__SRMST__
#define __RankingEDA__SRMST__
...
class CSRMST : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CSRMST(int problem_size, int sel_size, double b_ratio, int num_of_edge, string result_file_name);
...
#endif /* defined(__RankingEDA__SRMST__) */