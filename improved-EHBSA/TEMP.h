...
#ifndef __RankingEDA__TEMP__
#define __RankingEDA__TEMP__
...
class CTEMP : public CRankingModel
{
public:
	 ...
	 * The constructor.
	 */
	CTEMP(int problem_size, int sel_size, double b_ratio, int cut_point_count);
...
#endif /* defined(__RankingEDA__TEMP__) */